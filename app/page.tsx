...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-50 dark:bg-neutral-900 transition-colors duration-300">
      <div className="hero-section grid gap-8 md:grid-cols-2 items-center max-w-7xl mx-auto px-4 py-12 md:py-24">
          ...
          <h2 className="text-lg md:text-2xl font-medium text-neutral-800 dark:text-neutral-200 leading-relaxed">
            <TypeAnimation
              sequence={[
                "",
                2000,
                `I am Fatih Mekić, an aspiring frontend web developer with knowledge in HTML, CSS, JavaScript, React, Bootstrap, TailwindCSS, C, C++, Kotlin, Python, MongoDB and Neo4J.`,
                1000,
                `I am Fatih Mekić, an aspiring frontend web developer with knowledge in HTML, CSS, JavaScript, React, Bootstrap, TailwindCSS, C, C++, Kotlin, Python, MongoDB and Neo4J. I am currently polishing my React knowledge and am ready to code anytime.\nI also have experience in efficiently prompting various large language models to drastically boost my workflow.\n`,
                1000,
                `I am Fatih Mekić, an aspiring frontend web developer with knowledge in HTML, CSS, JavaScript, React, Bootstrap, TailwindCSS, C, C++, Kotlin, Python, MongoDB and Neo4J. I am currently polishing my React knowledge and am ready to code anytime.\nI also have experience in efficiently prompting various large language models to drastically boost my workflow.\nI am a big linux enthusiast and am a proud daily driver of Arch Linux, as it allows me to learn a lot about Linux processes and the system itself.\nI have a positive attitude towards learning new things and am always see`,
                1000,
